...
import Image from "next/image";
 ...
 function Page() {
  ...
  return (
    <div className="grid max-lg:flex max-lg:flex-col-reverse max-md:items-center grid-cols-2 w-full justify-between h-full  lg:pt-7  max-lg:pt-12  max-lg:gap-4">
      <div className="lg:w-4/5 w-full h-full rounded-md flex justify-start items-center ">
        <Songs/>
      </div>
